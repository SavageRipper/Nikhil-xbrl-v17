...
assert.match(app,/APP_VERSION='17\.0\.0'/); assert.match(app,/PROJECT_KEY='mcaCniXbrlProjectV17'/);
assert.match(app,/LEGACY_PROJECT_KEYS=\['mcaCniXbrlProjectV16','mcaCniXbrlProjectV15'/);
assert.match(app,/MCA_SCHEMA_REF='https:\/\/www\.mca\.gov\.in\/V3XBRL\/2016\/07\/26\/Taxonomy\/CnI\/in-ci-ent-2016-03-31\.xsd'/);
assert.match(app,/v15TableModels/); assert.match(app,/v15EnsureTableRow/); assert.match(app,/v15CreatePrimaryMemberRows/);
...
console.log('V17 smoke checks: PASS');
